...
(function () {
  ...
  var MATH_PALETTE_DATA = {
    ...
    algebra: [
      ...
      { label: '分块矩阵', code: '\\begin{pmatrix} A & B \\\\ C & D \\end{pmatrix}', render: '分块矩阵' }
    ],
    prob: [
    ...
    symbol: [
      ...
      { label: '千分号 ‰', code: '\\text{\\textperthousand}', render: '‰' },
